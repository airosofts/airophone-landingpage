      ...
      <section className="pt-0">
        <div className="max-w-[1280px] mx-auto px-5 sm:px-10 py-12 sm:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 items-center lg:min-h-[calc(100vh-56px)]">
          ...
          <div className="anim-up-delay relative flex flex-col items-center overflow-visible">
            ...
            <div className="absolute -right-2 top-1 sm:-right-[20px] sm:top-[50px] lg:-right-[30px] lg:top-[60px] bg-surface border border-border rounded-lg sm:rounded-xl px-2.5 py-2 sm:px-4 sm:py-3.5 shadow-[0_4px_16px_rgba(19,18,16,0.08)] sm:shadow-[0_8px_32px_rgba(19,18,16,0.10)] float z-10">
